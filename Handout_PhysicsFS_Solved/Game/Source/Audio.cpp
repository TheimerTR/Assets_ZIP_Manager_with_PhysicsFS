...
bool Audio::PlayMusic(const char* path, float fadeTime)
{
	...
	//TODO 6 (Solved): Use Mix_LoadMUS_RW to read from the PhysicsFS and not from common assets folder
...
unsigned int Audio::LoadFx(const char* path)
{
	...
	//TODO 6 (Solved): Use Mix_LoadWAV_RW to read from the PhysicsFS and not from common assets folder
